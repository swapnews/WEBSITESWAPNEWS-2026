...
export default async function ChannelPage({ params }: Props) {
    ...
    return <div className={`channel-page channel-${variant(data.category.slug)}`}>
        <header className="channel-mast"><Link href="/"><Image src="/swapnews-logo.png" alt="SwapNews" width={160} height={48} priority /></Link><nav><Link href="/">Beranda</Link><span>/</span><b>{data.category.name}</b></nav></header>
        <main>
